...
class TestTestPatterns < Minitest::Test
  def test_solid_fill_builds
    rom = RubyGBA::Cartridge::TestPatterns.solid_fill(:red)
  ...
  def test_solid_fill_default_color
    rom = RubyGBA::Cartridge::TestPatterns.solid_fill
    assert_kind_of RubyGBA::Cartridge::ROM, rom
  end

  def test_color_bars_builds
    rom = RubyGBA::Cartridge::TestPatterns.color_bars
    assert_kind_of RubyGBA::Cartridge::ROM, rom
    result = RubyGBA::Cartridge::ROMValidator.check(rom)
  ...
  def test_corners_builds
    rom = RubyGBA::Cartridge::TestPatterns.corners
    assert_kind_of RubyGBA::Cartridge::ROM, rom
    result = RubyGBA::Cartridge::ROMValidator.check(rom)
  ...
  def test_crosshair_builds
    rom = RubyGBA::Cartridge::TestPatterns.crosshair
    assert_kind_of RubyGBA::Cartridge::ROM, rom
    result = RubyGBA::Cartridge::ROMValidator.check(rom)
...
class TestTestPatternsRendering < Minitest::Test
  ...
  def test_solid_fill_renders_red
    ...
    rom = RubyGBA::Cartridge::TestPatterns.solid_fill(:red)
    v = RubyGBA::Diagnostics::Verifier.new(rom, frames: 10)
