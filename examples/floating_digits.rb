...
module FloatingDigits
  SCREEN_W = 240
  SCREEN_H = 160
  W = RubyGBA::Graphics::Fonts.default.width  # 5px wide glyph
  ...
  def self.glyph_art(d)
    lit = {}
    RubyGBA::Graphics::Fonts.default.each_pixel(d.to_s) { |x, y| lit[[x, y]] = true }
...
FloatingDigits::GAME.write_if_main
