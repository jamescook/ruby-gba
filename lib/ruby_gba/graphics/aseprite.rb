...
module RubyGBA
  module Graphics
    ...
    #
    # This module PARSES a JSON export into plain data (RubyGBA::Graphics::Aseprite::Doc), and reads the
    # native .aseprite binary straight into decoded frames (RubyGBA::Graphics::Aseprite::Sprite). Turning
