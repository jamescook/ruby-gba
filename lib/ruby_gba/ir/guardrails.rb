...
require_relative "guardrails/song_words" # shared by the music checks below
...
require_relative "guardrails/song_loops_into_silence"
  ...
  module IR
    module Guardrails
      ...
      BUILTIN_CHECKS = [
        ...
        Checks::SongLoopsIntoSilence.new,
