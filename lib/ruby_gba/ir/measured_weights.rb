  ...
  module IR
    class CostModel
      MEASURED_WEIGHTS = {
        ...
        bend_row_copied: 0.07267,
        bend_row_copied_fast: 0.02376,
        bend_line: 0.16216,
        bend_line_fast: 0.08880,
      ...
      WEIGHT_DOMAINS = {
        ...
        bend_row_copied: { varies: :rows_per_frame, from: 160, to: 160, note: "one row's offset written into the table the copier reads, from the cartridge" },
        bend_row_copied_fast: { varies: :rows_per_frame, from: 160, to: 160, note: "the same, from the quick memory" },
