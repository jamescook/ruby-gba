  ...
  module IR
    class CostModel
      MEASURED_WEIGHTS = {
        ...
        tearfree_moving_start: 0.08468,
        tearfree_rect_start: 0.03224,
      ...
      WEIGHT_DOMAINS = {
        ...
        loop_pass: { note: "one pass of a repeat — the counter, the compare and the branch back" },
        loop_start: { note: "entering a repeat, whatever it then does" },
