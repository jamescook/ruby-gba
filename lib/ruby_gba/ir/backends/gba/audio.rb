      ...
      class GBA
        ...
        class Audio
          ...
          def console_note(lane, part, frequency, volume)
            case lane.kind
            when :square
              RubyGBA::Audio::Sound::Registers.channel_note(lane.index, frequency: frequency, duty: part.duty, volume: volume)
            when :wave
              RubyGBA::Audio::Sound::Registers.wave_note(frequency: frequency, volume: volume)
            else
              RubyGBA::Audio::Sound::Registers.noise_note(frequency: frequency, volume: volume,
