      ...
      class GBA
        ...
        class Mixer
          ...
          def emit_start_envelope(slot, scratch, envelope)
            ...
            @emitter.emit(ASM.load_immediate(scratch, shape ? 0 : RubyGBA::Audio::Envelope::FULL))
          ...
          def emit_envelope_step
            ...
            e.emit(ASM.cmp_imm(2, RubyGBA::Audio::Envelope::FULL))
            e.emit(ASM.mov_imm_cond(:ge, 2, RubyGBA::Audio::Envelope::FULL))
            ...
            e.emit(ASM.lsr_imm(2, 2, RubyGBA::Audio::Envelope::SCALE))
            e.emit(ASM.cmp_reg(2, 3))
            ...
            e.emit(ASM.lsl_imm(0, 0, GAIN_FRACTION - RubyGBA::Audio::Envelope::SCALE))
            e.emit(ASM.cmp_imm(7, 0))
